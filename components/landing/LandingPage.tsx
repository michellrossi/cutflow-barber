...
const LandingPage: React.FC<{ onStart: () => void, onLogin: () => void }> = ({ onStart, onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] text-[#F8FAFC] font-sans selection:bg-[#F97316]/30 overflow-x-hidden">
      ...
      {/* SEÇÃO 1 — NAVBAR FIXA */}
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-[#0B0F19]/80 backdrop-blur-md border-b border-[#334155] py-3' : 'bg-transparent py-6'
          }`}
      >
