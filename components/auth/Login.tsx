                ...
                <form onSubmit={handleSubmit} className="space-y-5 bg-slate-900 p-8 rounded-2xl border border-slate-800 shadow-2xl">
                    ...
                    {isResetting ? (
                        ...
                        <div className="pt-2">
                            ...
                            <Link to="/signup?type=barber" className="w-full py-2 rounded-lg border border-slate-700 hover:bg-slate-800 text-slate-800 text-sm flex items-center justify-center gap-2 transition-colors">
