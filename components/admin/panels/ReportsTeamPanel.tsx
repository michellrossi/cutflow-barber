    ...
    return (
        <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                <h3 className="text-lg font-bold text-slate-900 mb-4">Top Profissionais</h3>
                <div className="space-y-4">
                    {professionals
                        ...
                        .map((pro, index) => (
                            <div key={pro.id} className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
